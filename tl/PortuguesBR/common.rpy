...
translate PortuguesBR strings:
    ...
    new "Salvar slot : [text]"

    # renpy/common/00action_file.rpy:444
    old "Load slot %s: [text]"
    new "Carregar slot : [text]"
    ...
    new "Falha ao salvar a captura de tela como ."

    # renpy/common/00keymap.rpy:318
    old "Saved screenshot as %s."
    new "Captura de tela salva como ."
    ...
    new "encaminhamento automático após clique"
    ...
    old "self voicing volume drop"
    new "queda do volume da voz própria"
    ...
    new "Voz própria ativada. Pressione 'v' para desativar."
    ...
    new "Clique com o botão direito ou escape para sair."
    ...
    new "Entrando em contato com a App Store  Por favor, aguarde ..."
    ...
    new "Continue, não mostre aviso novamente"
    ...
    old "Copy Markdown"
    new "Copiar remarcação"

    # renpy/common/_errorhandling.rpym:563
    old "Copies the traceback.txt file to the clipboard as Markdown for Discord."
    new "Copia o arquivo traceback.txt para a área de transferência como Markdown for Discord."
    ...
    new "Tenta reverter para um momento anterior, permitindo que você salve ou escolha uma escolha diferente."
