...
translate PortuguesBR strings:
    ...
    old "Время автоперемотки"
    new "Tempo de retrocesso automático"
    ...
    new "A história do diálogo está vazia."
    ...
    new "Pula o diálogo enquanto pressionado."
    ...
    new "Alterna {a=https://www.renpy.org/l/voicing} voz ativa {/a} assistiva."
    ...
    old "Right Click"
    new "Clique com o botão direito"

    # game/screens.rpy:1141
    old "Mouse Wheel Up\nClick Rollback Side"
    new "Roda do mouse para cima  Clique no lado reverso"
    ...
    old "Right Trigger\nA/Bottom Button"
    new "Botão direito do gatilho  A / inferior"
    ...
    new "Volte para o diálogo anterior."
    ...
    new "Avance para o diálogo posterior."
    ...
    new "Acesse o menu do jogo."

    # game/screens.rpy:1172
    old "Y/Top Button"
    new "Botão Y / Superior"
